        ...
        <div className="row justify-content-center offset-sm-2 col-sm-8">
            ...
            {videos.length > 0 && <nav>
                <ul className="pagination justify-content-center mt-3">
                    <li className={`page-item ${currentPage === 1 ? 'disabled' : ''}`}><p className='page-link' onClick={prevPage}>Previous</p></li>
                    <li className="page-item active"><p className='page-link'>{currentPage}</p></li>
